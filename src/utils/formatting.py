def format_size(size_in_bytes: int) -> str:
    ...
    i = 0
    # FIX: Divide by 1000 instead of 1024 to match qBittorrent's SI unit scaling
...
def format_speed(speed_in_bytes_per_sec: int) -> str:
    """Converts raw bytes/sec to human-readable speed exactly like qBittorrent (Base-10)."""
    try:
    ...
    i = 0
    # FIX: Divide by 1000 instead of 1024 to match qBittorrent's SI unit scaling
    while speed >= 1000 and i < len(speed_name) - 1:
        speed /= 1000.0
        i += 1
